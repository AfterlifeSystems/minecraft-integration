...
A Mineflayer body for a personal avatar on the **already-running** Neural Nexus API ([anubis](../anubis)). The browser is not used. Player phrases, latent `!` skills, voice, and host commands: [docs/COMMANDS.md](docs/COMMANDS.md).
